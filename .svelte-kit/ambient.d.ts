...
declare module '$env/static/private' {
	...
	export const PINECONE_API_ENV: string;
	...
	export const npm_package_dependencies_chartjs: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_package_dependencies_chartjs: string;
